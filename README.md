...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <sub>↻ 1,148 downloads · v2027.1.1</sub>
    </td>
    <td width="50%" valign="top">
...
hailo8-vlm-detections   Ready     268 detections yesterday
homelab-updates         Ready     2 commits yesterday
home-automation         Ready     828 triggers yesterday
claude-tokens           Burning   2.41B last 7 days 🔥
```

<sub>↻ this section is pushed by a CronJob running in the cluster itself · last sync: 2026-07-13 08:07 SAST · if this is stale, the lab is probably on fire</sub>
