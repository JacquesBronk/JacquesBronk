...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <sub>↻ 1,168 downloads · v2027.1.1</sub>
    </td>
    <td width="50%" valign="top">
...
k3s-cluster             Ready     26 namespaces, 3 nodes
hailo8-vlm-detections   Ready     362 detections yesterday
homelab-updates         Ready     0 commits yesterday
home-automation         Ready     1,383 triggers yesterday
claude-tokens           Burning   324.4M last 7 days 🔥
```

<sub>↻ this section is pushed by a CronJob running in the cluster itself · last sync: 2026-08-29 08:07 SAST · if this is stale, the lab is probably on fire</sub>
