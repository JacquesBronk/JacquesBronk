...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <sub>↻ 1,160 downloads · v2027.1.1</sub>
    </td>
    <td width="50%" valign="top">
...
homelab-updates         Ready     2 commits yesterday
home-automation         Ready     1,576 triggers yesterday
claude-tokens           Burning   130.9M last 7 days 🔥
```

<sub>↻ this section is pushed by a CronJob running in the cluster itself · last sync: 2026-08-15 08:07 SAST · if this is stale, the lab is probably on fire</sub>
