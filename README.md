...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <sub>↻ 1,185 downloads · v2027.1.1</sub>
    </td>
    <td width="50%" valign="top">
...
hailo8-vlm-detections   Ready     127 detections yesterday
homelab-updates         Ready     0 commits yesterday
home-automation         Ready     831 triggers yesterday
claude-tokens           Burning   2.8M last 7 days 🔥
```

<sub>↻ this section is pushed by a CronJob running in the cluster itself · last sync: 2026-09-21 08:07 SAST · if this is stale, the lab is probably on fire</sub>
