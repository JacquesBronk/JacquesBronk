...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <sub>↻ 1,152 downloads · v2027.1.1</sub>
    </td>
    <td width="50%" valign="top">
...
hailo8-vlm-detections   Ready     853 detections yesterday
homelab-updates         Ready     14 commits yesterday
home-automation         Ready     1,581 triggers yesterday
claude-tokens           Burning   3.07B last 7 days 🔥
```

<sub>↻ this section is pushed by a CronJob running in the cluster itself · last sync: 2026-08-01 14:07 SAST · if this is stale, the lab is probably on fire</sub>
